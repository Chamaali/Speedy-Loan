  ...
  return (
    ...
    <Container>
        <Row className='heading'>
            <h1 className='hd1'>Personal Loan</h1>
        </Row>
        <Row className='para'>
            <h5 className='hd5'>FIND THE BEST LOAN SOLUTIONS</h5>
            <p className='pa'>Personal loans are available for the salaried employees and the self employed, at an attractive rate of interest.</p>
