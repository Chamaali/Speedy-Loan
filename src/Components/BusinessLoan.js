  ...
  return (
    <Container>
        <Row className='heading'>
            <h1 className='hd1'>Business Loan</h1>
        </Row>
        <Row className='para'>
            <h5 className='hd5'>FIND THE BEST LOAN SOLUTIONS</h5>
            <p className='pa'>We can arrange the flexible funding solutions for your business in order to meet your working capital requirements, purchase of machinery or business expansion projects.</p>
